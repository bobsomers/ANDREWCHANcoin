...
static const int64 MAX_MONEY = 10000000000ULL * COIN; // ANDREWCHANcoin: 214B total coins, 10B max transaction for now
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
static const int COINBASE_MATURITY = 10; // +20 is added to this later in the code...
